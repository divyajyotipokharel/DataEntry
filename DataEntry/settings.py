...
TEMPLATE_DIR = os.path.join(BASE_DIR,'operator_form/templates/operator_form')
...
INSTALLED_APPS = [
    ...
    'operator_form',
    # 'admin_form',
    'admin_form.apps.AdminFormConfig',
]
...
MIDDLEWARE = [
    ...
    'admin_form.middleware.OneSessionPerUserMiddleware',
]
